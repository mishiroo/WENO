...
for n in NList:
    ...
    # 用户只需要实现需要的函数即可
    theo_values = test_case.getTheoValues(TestCase.sin_fun)
    avg_values = test_case.getAverageValues(TestCase.sin_fun)
...
EA.SaveError("WENO5Error-sin.xlsx", NList, l2_err_list, linf_err_list)
